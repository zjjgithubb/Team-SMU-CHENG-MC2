...
To better visualise the IUU behaviours of the fishing vessels, we can first compare the dwell times of the vessels at the various location. This is done through the first tab - "Compare Dwell Times", where users can select the Company, Vessels and Location Type. To look at specific areas, such as Nemo Reef etc, users can next specify the actual location (or source) for the comparison.
